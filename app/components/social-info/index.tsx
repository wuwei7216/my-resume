  ...
  return (
    <div className={cn(styles.socialInfo)}>
      ...
      <div className={styles.socialItem} key={"GitHub"}>
        ...
        <a className={styles.link} href="https://github.com/li-jia-nan" target="_blank">
          https://github.com/li-jia-nan
        </a>
      </div>
      ...
      <div className={styles.socialItem} key={"Juejin"}>
        ...
        <a
          ...
          href="https://juejin.cn/user/782508010775198/posts"
          target="_blank"
        >
          https://juejin.cn/user/782508010775198/posts
        </a>
      </div>
    </div>
  );
